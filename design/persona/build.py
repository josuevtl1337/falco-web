...
# Etiqueta chica arriba de cada ficha (antes era el arcano; los arcanos se sacaron el 2026-09-19).
TAGS = {
    "[Huila] · Colombia": "Café · Colombia",
    "[Etiopía] natural": "Café · Etiopía",
    "Blend de casa": "Café · Blend",
    "Descafeinado": "Café · Descafeinado",
    "Kit primer café": "Kit",
    "Aeropress": "Accesorio",
    "Kit V60 completo": "Kit",
    "Filtros V60 · 02": "Accesorio",
    "Remera Falco": "Remera",
}


def card(num, arc, ic, prod, detail, why, new, flip=False):
    """Ficha de la tienda. `num`, `arc`, `ic`, `why` y `flip` quedan por compatibilidad con los datos viejos."""
    burst = '<span class="burst">Nuevo</span>' if new else ""
    return f'''<article class="pc" tabindex="0" aria-label="{prod}. {detail}">{burst}
          <div class="pc-front">
            <div class="pc-shot"></div>
            <div class="pc-body">
              <span class="pc-code">{TAGS.get(prod, "")}</span>
